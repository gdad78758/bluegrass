...
3. Once we're happy with the chopro file then from the main bluegrass folder
   ...
   4. The random selection is appended to random.log, and Random.chopro and Random.html are committed to the repo.
   5. The generated Random.pdf is published to GitHub Pages only and is not committed to the repo.
